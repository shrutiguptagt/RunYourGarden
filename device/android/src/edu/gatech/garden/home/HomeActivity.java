...
public class HomeActivity extends Activity {
    ...
    private void facebookLogin() {
        ...
        try {
            ...
            String resp = Communicator.communicate(bundle, Communicator.LOGIN_URL);
            ...
            remainDistance = Double.parseDouble(resJson.getString("remain_distance"));
            remainTime = Long.parseLong(resJson.getString("remain_time"));
            remainCalories = Long.parseLong(resJson.getString("remain_calories"));
